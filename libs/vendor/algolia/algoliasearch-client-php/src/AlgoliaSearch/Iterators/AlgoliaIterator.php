...
abstract class AlgoliaIterator implements \Iterator
{
     ...
     */
    public function __construct(\WC_Order_Search_Admin\AlgoliaSearch\Index $index, $hitsPerPage = 1000)
    {
        if ($hitsPerPage <= 0) {
     ...
     */
    protected abstract function fetchCurrentPageResults();
    /**
     ...
     */
    protected abstract function formatHit(array $hit);
}
