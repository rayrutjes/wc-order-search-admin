...
class Installer extends \WC_Order_Search_Admin\Composer\Installer\LibraryInstaller
{
    /**
     ...
     * {@inheritDoc}
     */
    public function getInstallPath(\WC_Order_Search_Admin\Composer\Package\PackageInterface $package)
    {
    ...
    public function uninstall(\WC_Order_Search_Admin\Composer\Repository\InstalledRepositoryInterface $repo, \WC_Order_Search_Admin\Composer\Package\PackageInterface $package)
    {
