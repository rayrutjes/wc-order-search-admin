...
use Composer\Config;
class InstallerTest extends \WC_Order_Search_Admin\Composer\Installers\Test\TestCase
{
    private $composer;
    private $config;
    private $vendorDir;
    ...
    {
        $this->fs = new \WC_Order_Search_Admin\Composer\Util\Filesystem();
        $this->composer = new \WC_Order_Search_Admin\Composer\Composer();
        $this->config = new \WC_Order_Search_Admin\Composer\Config();
    ...
    {
        $installer = new \WC_Order_Search_Admin\Composer\Installers\Installer($this->io, $this->composer);
    ...
    {
        $installer = new \WC_Order_Search_Admin\Composer\Installers\Installer($this->io, $this->composer);
        $package = new \WC_Order_Search_Admin\Composer\Package\Package($name, $version, $version);
    ...
    {
        $installer = new \WC_Order_Search_Admin\Composer\Installers\Installer($this->io, $this->composer);
        $package = new \WC_Order_Search_Admin\Composer\Package\Package('shama/ftp', '1.0.0', '1.0.0');
    ...
    public function testCustomInstallPath()
    {
        ...
        $consumerPackage = new \WC_Order_Search_Admin\Composer\Package\RootPackage('foo/bar', '1.0.0', '1.0.0');
    ...
    {
        $installer = new \WC_Order_Search_Admin\Composer\Installers\Installer($this->io, $this->composer);
        $package = new \WC_Order_Search_Admin\Composer\Package\Package('shama/cakephp-ftp-plugin', '1.0.0', '1.0.0');
        $package->setType('cakephp-plugin');
    ...
    {
        $installer = new \WC_Order_Search_Admin\Composer\Installers\Installer($this->io, $this->composer);
        $package = new \WC_Order_Search_Admin\Composer\Package\Package('slbmeh/my_plugin', '1.0.0', '1.0.0');
        $package->setType('wordpress-plugin');
        $consumerPackage = new \WC_Order_Search_Admin\Composer\Package\RootPackage('foo/bar', '1.0.0', '1.0.0');
        $this->composer->setPackage($consumerPackage);
        $consumerPackage->setExtra(array('installer-paths' => array('my/custom/path/{$name}/' => array('type:wordpress-plugin'))));
        $result = $installer->getInstallPath($package);
    ...
    {
        $installer = new \WC_Order_Search_Admin\Composer\Installers\Installer($this->io, $this->composer);
        $package = new \WC_Order_Search_Admin\Composer\Package\Package('penyaskito/my_module', '1.0.0', '1.0.0');
        $package->setType('drupal-module');
        $consumerPackage = new \WC_Order_Search_Admin\Composer\Package\RootPackage('drupal/drupal', '1.0.0', '1.0.0');
        $this->composer->setPackage($consumerPackage);
    ...
    {
        $installer = new \WC_Order_Search_Admin\Composer\Installers\Installer($this->io, $this->composer);
        $package = new \WC_Order_Search_Admin\Composer\Package\Package('sfPhpunitPlugin', '1.0.0', '1.0.0');
    ...
    {
        $installer = new \WC_Order_Search_Admin\Composer\Installers\Installer($this->io, $this->composer);
        $package = new \WC_Order_Search_Admin\Composer\Package\Package('typo3/fluid', '1.0.0', '1.0.0');
    ...
    {
        $package = new \WC_Order_Search_Admin\Composer\Package\Package('foo', '1.0.0', '1.0.0');
