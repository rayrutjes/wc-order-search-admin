...
class GravInstallerTest extends \WC_Order_Search_Admin\Composer\Installers\Test\TestCase
{
    ...
    public function testInflectPackageVars()
    {
        ...
        $installer = new \WC_Order_Search_Admin\Composer\Installers\GravInstaller($package, $this->composer);
