 ...
 */
class PiwikInstallerTest extends \WC_Order_Search_Admin\Composer\Installers\Test\TestCase
{
    /**
     * @varComposer
     */
    ...
    {
        $this->package = new \WC_Order_Search_Admin\Composer\Package\Package('VisitSummary', '1.0', '1.0');
    ...
    {
        $installer = new \WC_Order_Search_Admin\Composer\Installers\PiwikInstaller($this->package, $this->composer);
