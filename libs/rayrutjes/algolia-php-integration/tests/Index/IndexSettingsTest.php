...
use RayRutjes\AlgoliaIntegration\Index\IndexReplicaSettings;
...
class IndexSettingsTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCanRetrieveReplicaSettings()
    {
        ...
        $this->assertInstanceOf('RayRutjes\AlgoliaIntegration\Index\IndexReplicaSettings', $replicaSettings[0]);
        ...
        $this->assertInstanceOf('RayRutjes\AlgoliaIntegration\Index\IndexReplicaSettings', $replicaSettings[1]);
