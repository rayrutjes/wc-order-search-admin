...
class OrdersListPage
{
    ...
    public function enqueue_scripts()
    {
        ...
        wp_enqueue_style('aos_orders_search', plugin_dir_url(__FILE__).'../../css/styles.css', array(), AOS_VERSION);
        ...
        wp_enqueue_script('aos_orders_search', plugin_dir_url(__FILE__).'../../js/orders-autocomplete.js', array('aos_algolia', 'aos_autocomplete', 'jquery'), AOS_VERSION, true);
